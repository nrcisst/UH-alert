...
"[project]/src/app/api/subscriptions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const subscriptions = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].subscription.findMany({
            where: {
                userId: user.id,
                active: true
            },
        ...
        const subscriptionsWithStatus = await Promise.all(subscriptions.map(async (sub)=>{
            const cached = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].classCache.findUnique({
                where: {
                    subject_catalogNbr: {
                        subject: sub.subject,
...
async function POST(request) {
    try {
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].subscription.findUnique({
            where: {
        ...
        if (existing) {
            ...
            const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].subscription.update({
                where: {
                    id: existing.id
                },
                data: {
        ...
        const subscription = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].subscription.create({
            data: {
                userId: user.id,
                subject: subject.toUpperCase(),
                catalogNbr: catalogNbr.toString(),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__da9a896c._.js.map